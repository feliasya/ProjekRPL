...
<div>
    <form action="<?php echo base_url();?>index.php/createAccount/aksi_akunBaru" method="post">
        ...
        <input type="text" id="fnama" name="inputNama" placeholder="Nama Lengkap">
        ...
        <input type="text" id="lfakultas" name="inputFakultas" placeholder="Fakultas">

        <label for="ljurusan">Program Studi</label>
        <input type="text" id="ljurusan" name="inputJurusan" placeholder="Program Studi">

        <label for="lnpm">NPM</label>
        <input type="text" id="lnpm" name="inputNPM" placeholder="NPM">

        <label for="langkatan">Angkatan</label>
        <input type="text" id="langkatan" name="inputAngkatan" placeholder="Angkatan">

        <p><h5>Gunakan 16 karakter unik yang mudah diingat untuk username anda</h5></p>
        <label for="uname">Username</label>
        <input type="text" id="uname" name="inputUname" placeholder="Username">
        
        <label for="psswrd">Password</label>
        <input type="password" id="psswrd" name="inputPw" placeholder="password">
